...
| Domain | Owner | Initial behavior |
|---|---|---|
| `vraxis.dev` | Vraxis site | Ecosystem homepage and CLI install path |
| `www.vraxis.dev` | Vraxis site | Permanent redirect to the apex domain |
| `read.vraxis.dev` | Vraxis Read | Product marketing and install guidance |
| `aperta.vraxis.dev` | Aperta | Product marketing and install guidance |
